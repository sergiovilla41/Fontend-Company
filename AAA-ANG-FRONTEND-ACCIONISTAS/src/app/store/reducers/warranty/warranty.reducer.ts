...
import { newWarrantySuccess, newWarrantyError, updateWarrantySuccess, updateWarrantyError, deleteWarrantySuccess, deleteWarrantyError, UpdateStateWarranty } from '../../actions/warranty.action';
...
export const warrantyReducer = createReducer(
  warrantyInitialState,
    on(newWarrantySuccess, (state, { msg, status }) => {
        return { ...state, msg, status }
    }),
    on(newWarrantyError, (state, { msg, status }) => {
        return { ...state, msg, status }
    }),
    on(updateWarrantySuccess, (state, { msg, status }) => {
        return { ...state, msg, status }
    }),
    on(updateWarrantyError, (state, { msg, status }) => {
        return { ...state, msg, status }
    }),
    on(deleteWarrantySuccess, (state, { msg, status }) => {
        return { ...state, msg, status }
    }),
    on(deleteWarrantyError, (state, { msg, status }) => {
        return { ...state, msg, status }
    }),
    on(UpdateStateWarranty, (state) => {
        return { status: null }
    }),
